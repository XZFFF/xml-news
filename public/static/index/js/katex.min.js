!function (t, e) {
    ...
    return function (t) {
        ...
        var n = r(0), a = r.n(n), o = function () {
            ...
            a()(this, t);
            var n = "KaTeX parse error: " + e, o = void 0, i = r && r.loc;
            if (i && i.start <= i.end) {
                var s = i.lexer.input;
                o = i.start;
                var h = i.end;
                ...
                n += (o > 15 ? "\u2026" + s.slice(o - 15, o) : s.slice(0, o)) + l + (h + 15 < s.length ? s.slice(h, h + 15) + "\u2026" : s.slice(h))
            }
            var m = new Error(n);
            return m.name = "ParseError", m.__proto__ = t.prototype, m.position = o, m
        };
        ...
        var p = function t(e) {
                ...
                return t.prototype.sup = function () {
                    return x[v[this.id]]
            ...
            x = [new g(0, 0, !1), new g(1, 0, !0), new g(2, 1, !1), new g(3, 1, !0), new g(4, 2, !1), new g(5, 2, !0), new g(6, 3, !1), new g(7, 3, !0)],
            v = [4, 5, 4, 5, 6, 7, 6, 7], y = [5, 5, 5, 5, 7, 7, 7, 7], b = [2, 3, 4, 5, 6, 7, 6, 7],
            w = [3, 3, 5, 5, 7, 7, 7, 7], k = [1, 1, 3, 3, 5, 5, 7, 7], S = [0, 1, 2, 3, 2, 3, 2, 3],
            M = {DISPLAY: x[0], TEXT: x[2], SCRIPT: x[4], SCRIPTSCRIPT: x[6]},
            z = [{name: "latin", blocks: [[256, 591], [768, 879]]}, {
                name: "cyrillic",
                blocks: [[1024, 1279]]
        ...
        function A(t) {
            for (var e = 0; e < T.length; e += 2) if (t >= T[e] && t <= T[e + 1]) return !0;
            return !1
        }
        ...
        var B = {
                ...
                function t(e) {
                    a()(this, t), this.children = e, this.classes = [], this.height = 0, this.depth = 0, this.maxFontSize = 0, this.style = {}
                }

                return t.prototype.hasClass = function (t) {
                ...
                for (var r in e.className = N(this.classes), this.style) this.style.hasOwnProperty(r) && (e.style[r] = this.style[r]);
                ...
                var e = "<" + t;
                this.classes.length && (e += ' class="' + d.escape(N(this.classes)) + '"');
                var r = "";
                for (var n in this.style) this.style.hasOwnProperty(n) && (r += d.hyphenate(n) + ":" + this.style[n] + ";");
                for (var a in r && (e += ' style="' + d.escape(r) + '"'), this.attributes) this.attributes.hasOwnProperty(a) && (e += " " + a + '="' + d.escape(this.attributes[a]) + '"');
                e += ">";
                ...
                return t.prototype.setAttribute = function (t, e) {
                    this.attributes[t] = e
                ...
                function t(e, r, n, o) {
                    a()(this, t), q.call(this, r, o), this.children = n || [], this.setAttribute("href", e)
                }
            ...
            }(), L = {"\xee": "\u0131\u0302", "\xef": "\u0131\u0308", "\xed": "\u0131\u0301", "\xec": "\u0131\u0300"},
            H = function () {
                function t(e, r, n, o, i, s, h, l) {
                    a()(this, t), this.text = e, this.height = r || 0, this.depth = n || 0, this.italic = o || 0, this.skew = i || 0, this.width = s || 0, this.classes = h || [], this.style = l || {}, this.maxFontSize = 0;
                    var m = function (t) {
                        for (var e = 0; e < z.length; e++) for (var r = z[e], n = 0; n < r.blocks.length; n++) {
                            var a = r.blocks[n];
                            if (t >= a[0] && t <= a[1]) return r.name
                        }
                        return null
                    }(this.text.charCodeAt(0));
                    m && this.classes.push(m + "_fallback"), /[\xee\xef\xed\xec]/.test(this.text) && (this.text = L[this.text])
                }

                return t.prototype.hasClass = function (t) {
                    return d.contains(this.classes, t)
                }, t.prototype.tryCombine = function (e) {
                    if (!e || !(e instanceof t) || this.italic > 0 || N(this.classes) !== N(e.classes) || this.skew !== e.skew || this.maxFontSize !== e.maxFontSize) return !1;
                    for (var r in this.style) if (this.style.hasOwnProperty(r) && this.style[r] !== e.style[r]) return !1;
                    for (var n in e.style) if (e.style.hasOwnProperty(n) && this.style[n] !== e.style[n]) return !1;
                    return this.text += e.text, this.height = Math.max(this.height, e.height), this.depth = Math.max(this.depth, e.depth), this.italic = e.italic, !0
                }, t.prototype.toNode = function () {
                    var t = document.createTextNode(this.text), e = null;
                    for (var r in this.italic > 0 && ((e = document.createElement("span")).style.marginRight = this.italic + "em"), this.classes.length > 0 && ((e = e || document.createElement("span")).className = N(this.classes)), this.style) this.style.hasOwnProperty(r) && ((e = e || document.createElement("span")).style[r] = this.style[r]);
                    return e ? (e.appendChild(t), e) : t
                }, t.prototype.toMarkup = function () {
                    var t = !1, e = "<span";
                    this.classes.length && (t = !0, e += ' class="', e += d.escape(N(this.classes)), e += '"');
                    var r = "";
                    for (var n in this.italic > 0 && (r += "margin-right:" + this.italic + "em;"), this.style) this.style.hasOwnProperty(n) && (r += d.hyphenate(n) + ":" + this.style[n] + ";");
                ...
                function t(e, r) {
                    a()(this, t), this.children = e || [], this.attributes = r || {}
                }

                return t.prototype.toNode = function () {
                ...
                return t.prototype.toNode = function () {
                    ...
                    return this.alternate ? t.setAttribute("d", this.alternate) : t.setAttribute("d", B.path[this.pathName]), t
                }, t.prototype.toMarkup = function () {
                    return this.alternate ? "<path d='" + this.alternate + "'/>" : "<path d='" + B.path[this.pathName] + "'/>"
                }, t
            }(), F = function () {
                function t(e) {
        ...
        function X(t, e, r) {
            if (!V[e]) throw new Error("Font metrics not found for font: " + e + ".");
            var n = t.charCodeAt(0);
            t[0] in U && (n = U[t[0]].charCodeAt(0));
            var a = V[e][n];
            if (a || "text" !== r || A(n) && (a = V[e][77]), a) return {
                depth: a[0],
                height: a[1],
                italic: a[2],
                skew: a[3],
        ...
        for (var lt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", mt = 0; mt < lt.length; mt++) {
            var ct = lt.charAt(mt);
            Z("math", K, tt, ct, ct), Z("text", K, "textord", ct, ct)
        }
        for (var pt = "", ut = 0; ut < lt.length; ut++) {
            var dt = lt.charAt(ut);
            Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56320 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56372 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56424 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56580 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56736 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56788 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56840 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56944 + ut)), Z("text", K, "textord", dt, pt), ut < 26 && (Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56632 + ut)), Z("text", K, "textord", dt, pt), Z("math", K, tt, dt, pt = String.fromCharCode(55349, 56476 + ut)), Z("text", K, "textord", dt, pt))
        }
        Z("math", K, tt, "k", pt = String.fromCharCode(55349, 56668)), Z("text", K, "textord", "k", pt);
        for (var ft = 0; ft < 10; ft++) {
            var gt = ft.toString();
            Z("math", K, tt, gt, pt = String.fromCharCode(55349, 57294 + ft)), Z("text", K, "textord", gt, pt), Z("math", K, tt, gt, pt = String.fromCharCode(55349, 57314 + ft)), Z("text", K, "textord", gt, pt), Z("math", K, tt, gt, pt = String.fromCharCode(55349, 57324 + ft)), Z("text", K, "textord", gt, pt), Z("math", K, tt, gt, pt = String.fromCharCode(55349, 57334 + ft)), Z("text", K, "textord", gt, pt)
        }
        ...
        Z("text", K, "textord", "\xf0", "\xf0"), Z("text", K, "textord", "\u2013", "\u2013"), Z("text", K, "textord", "\u2014", "\u2014"), Z("text", K, "textord", "\u2018", "\u2018"), Z("text", K, "textord", "\u2019", "\u2019"), Z("text", K, "textord", "\u201c", "\u201c"), Z("text", K, "textord", "\u201d", "\u201d");
        var yt = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathit", "textit", "Math-Italic"], ["mathit", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            bt = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]],
            wt = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
            kt = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], St = function (t, e) {
                return e.size < 2 ? t : wt[t - 1][e.size - 1]
            }, Mt = function () {
                function t(e) {
                    a()(this, t), this.style = e.style, this.color = e.color, this.size = e.size || t.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = kt[this.size - 1], this.maxSize = e.maxSize, this._fontMetrics = void 0
                }
                ...
                return t.prototype.extend = function (e) {
                    ...
                    return this.style === t ? this : this.extend({style: t, size: St(this.textSize, t)})
        ...
        var zt = Mt, Tt = {
                ...
                sp: 1 / 65536,
                px: 1.00375
            }, At = {ex: !0, em: !0, mu: !0}, Bt = function (t, e) {
                var r = void 0;
                if (t.unit in Tt) r = Tt[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier; else if ("mu" === t.unit) r = e.fontMetrics().cssEmPerMu; else {
                    var n = void 0;
                    if (n = e.style.isTight() ? e.havingStyle(e.style.text()) : e, "ex" === t.unit) r = n.fontMetrics().xHeight; else {
                        if ("em" !== t.unit) throw new h("Invalid unit: '" + t.unit + "'");
                        r = n.fontMetrics().quad
                    }
                    n !== e && (r *= n.sizeMultiplier / e.sizeMultiplier)
                }
                return Math.min(t.number * r, e.maxSize)
            }, Ct = ["\\imath", "\u0131", "\\jmath", "\u0237", "\\pounds", "\\mathsterling", "\\textsterling", "\xa3"],
            Nt = function (t, e, r) {
                return $[r][t] && $[r][t].replace && (t = $[r][t].replace), {value: t, metrics: X(t, e, r)}
            }, qt = function (t, e, r, n, a) {
                var o = Nt(t, e, r), i = o.metrics;
                t = o.value;
                var s = void 0;
                if (i) {
                    var h = i.italic;
                    "text" === r && (h = 0), s = new H(t, i.height, i.depth, h, i.skew, i.width, a)
                } else "undefined" != typeof console && console.warn("No character metrics for '" + t + "' in style '" + e + "'"), s = new H(t, 0, 0, 0, 0, 0, a);
                if (n) {
                ...
                if ("textord" === a) {
                    ...
                    if ("ams" === i) {
                        ...
                        return qt(t, s, e, r, n.concat("amsrm", r.fontWeight, r.fontShape))
                    }
                    if ("main" !== i && i) {
                ...
                for (var e = 0, r = 0, n = 0, a = 0; a < t.children.length; a++) {
                    var o = t.children[a];
                    o.height > e && (e = o.height), o.depth > r && (r = o.depth), o.maxFontSize > n && (n = o.maxFontSize)
                }
                ...
                mathsym: function (t, e, r) {
                    ...
                    return r && r.font && "boldsymbol" === r.font && Nt(t, "Main-Bold", e).metrics ? qt(t, "Main-Bold", e, r, n.concat(["mathbf"])) : "\\" === t || "main" === $[e][t].font ? qt(t, "Main-Regular", e, r, n) : qt(t, "AMS-Regular", e, r, n.concat(["amsrm"]))
                },
                makeSpan: Rt,
                makeSvgSpan: Lt,
                ...
                makeVList: function (t, e) {
                    for (var r = function (t) {
                        if ("individualShift" === t.positionType) {
                            for (var e = t.children, r = [e[0]], n = -e[0].shift - e[0].elem.depth, a = n, o = 1; o < e.length; o++) {
                    ...
                    for (var m = [], c = a, p = a, u = a, d = 0; d < n.length; d++) {
                        var f = n[d];
                        if ("kern" === f.type) u += f.size; else {
                            var g = f.elem, x = f.wrapperClasses || [], v = f.wrapperStyle || {},
                                y = Rt(x, [l, g], void 0, v);
                            y.style.top = -o - u - g.depth + "em", f.marginLeft && (y.style.marginLeft = f.marginLeft), f.marginRight && (y.style.marginRight = f.marginRight), m.push(y), u += g.height + g.depth
                        }
                    ...
                    var z = Rt(["vlist-t"], w);
                    return 2 === w.length && z.classes.push("vlist-t2"), z.height = p, z.depth = -c, z
                },
                makeOrd: function (t, e, r) {
                    var n = t.mode, a = t.text, o = ["mord"], i = "math" === n || "text" === n && e.font,
                    ...
                    if (s) {
                        ...
                        } else i ? (p = Pt[s].fontName, u = [s]) : (p = Dt(s, e.fontWeight, e.fontShape), u = [s, e.fontWeight, e.fontShape]);
                        if (Nt(a, p, n).metrics) return qt(a, p, n, e, o.concat(u));
                        if (at.hasOwnProperty(a) && "Typewriter" === p.substr(0, 10)) {
                            for (var x = [], v = 0; v < a.length; v++) x.push(qt(a[v], p, n, e, o.concat(u)));
                            return Ht(x)
                        }
                        return Et(a, n, e, o, r)
                    }
                ...
                makeVerb: function (t, e) {
                    var r = t.body;
                    return r = t.star ? r.replace(/ /g, "\u2423") : r.replace(/ /g, "\xa0")
                },
                makeGlue: function (t, e) {
                    var r = Rt(["mspace"], [], e), n = Bt(t, e);
                    return r.style.marginRight = n + "em", r
                },
                staticSvg: function (t, e) {
                    var r = Ft[t], n = r[0], a = r[1], o = r[2], i = new P(n), s = new D([i], {
                        width: a + "em",
                        height: o + "em",
                        style: "width:" + a + "em",
                    ...
                    return h.height = o, h.style.height = o + "em", h.style.width = a + "em", h
                },
                svgData: Ft,
                tryCombineChars: function (t) {
                    for (var e = 0; e < t.length - 1; e++) t[e].tryCombine(t[e + 1]) && (t.splice(e + 1, 1), e--);
                    return t
                },
        ...
        var _t = {number: 3, unit: "mu"}, Wt = {number: 4, unit: "mu"}, jt = {number: 5, unit: "mu"}, $t = {
            ...
            mpunct: {mord: _t, mop: _t, mrel: jt, mopen: _t, mclose: _t, mpunct: _t, minner: _t},
            minner: {mord: _t, mop: _t, mbin: Wt, mrel: jt, mopen: _t, mpunct: _t, minner: _t}
        }, Zt = {
            mord: {mop: _t},
            mop: {mord: _t, mop: _t},
            mbin: {},
        ...
        function te(t) {
            for (var e = t.type, r = (t.nodeType, t.names), n = t.props, a = t.handler, o = t.htmlBuilder, i = t.mathmlBuilder, s = {
                type: e,
                numArgs: n.numArgs,
                argTypes: n.argTypes,
        ...
        var re = function (t) {
            var e = Ut(t, "ordgroup");
            return e ? e.body : [t]
        }, ne = Vt.makeSpan, ae = function (t, e) {
            return t ? d.contains(["mbin", "mopen", "mrel", "mop", "mpunct"], me(t, "right")) : e
        }, oe = function (t, e) {
            return t ? d.contains(["mrel", "mclose", "mpunct"], me(t, "left")) : e
        }, ie = {display: M.DISPLAY, text: M.TEXT, script: M.SCRIPT, scriptscript: M.SCRIPTSCRIPT}, se = {
            mord: "mord",
            mop: "mop",
            mbin: "mbin",
            mrel: "mrel",
            ...
            for (var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [null, null], a = [], o = 0; o < t.length; o++) {
                var i = ue(t[o], e);
                if (i instanceof C) {
                    var s = i.children;
                    a.push.apply(a, s)
            ...
            for (var h = [n[0] ? ne([n[0]], [], e) : null].concat(a.filter(function (t) {
                return t && "mspace" !== t.classes[0]
            }), [n[1] ? ne([n[1]], [], e) : null]), l = 1; l < h.length - 1; l++) {
                var m = u(h[l]), c = le(m, "left");
                "mbin" === c.classes[0] && ae(h[l - 1], r) && (c.classes[0] = "mord");
                var p = le(m, "right");
                "mbin" === p.classes[0] && oe(h[l + 1], r) && (p.classes[0] = "mord")
            }
            for (var d = [], f = 0, g = 0; g < a.length; g++) if (d.push(a[g]), "mspace" !== a[g].classes[0] && f < h.length - 1) {
                0 === f && (d.pop(), g--);
                var x = me(h[f], "right"), v = me(h[f + 1], "left");
                if (x && v && r) {
                    var y = u(h[f + 1]), b = ce(y) ? Zt[x][v] : $t[x][v];
                    if (b) {
                        var w = e;
                        if (1 === t.length) {
                            var k = Ut(t[0], "sizing") || Ut(t[0], "styling");
                            k && ("sizing" === k.type ? w = e.havingSize(k.size) : "styling" === k.type && (w = e.havingStyle(ie[k.style])))
                        }
        ...
        function fe(t, e) {
            ...
            for (var n = he(t, e, !0), a = [], o = [], i = 0; i < n.length; i++) if (o.push(n[i]), n[i].hasClass("mbin") || n[i].hasClass("mrel") || n[i].hasClass("allowbreak")) {
                for (var s = !1; i < n.length - 1 && n[i + 1].hasClass("mspace");) i++, o.push(n[i]), n[i].hasClass("nobreak") && (s = !0);
                s || (a.push(de(o, e)), o = [])
            } else n[i].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(de(o, e)), o = []), a.push(n[i]));
        ...
        var xe = function () {
            function t(e, r) {
                a()(this, t), this.type = e, this.attributes = {}, this.children = r || []
            }
            ...
            return t.prototype.setAttribute = function (t, e) {
                ...
                var t = "<" + this.type;
                for (var e in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, e) && (t += " " + e + '="', t += d.escape(this.attributes[e]), t += '"');
                t += ">";
                for (var r = 0; r < this.children.length; r++) t += this.children[r].toMarkup();
                return t += "</" + this.type + ">"
            }, t.prototype.toText = function () {
            ...
            function t(e) {
                a()(this, t), this.width = e, this.character = e >= .05555 && e <= .05556 ? "&VeryThinSpace;" : e >= .1666 && e <= .1667 ? "&ThinSpace;" : e >= .2222 && e <= .2223 ? "&MediumSpace;" : e >= .2777 && e <= .2778 ? "&ThickSpace;" : e >= -.05556 && e <= -.05555 ? "&NegativeVeryThinSpace;" : e >= -.1667 && e <= -.1666 ? "&NegativeThinSpace;" : e >= -.2223 && e <= -.2222 ? "&NegativeMediumSpace;" : e >= -.2778 && e <= -.2777 ? "&NegativeThickSpace;" : null
            }
        ...
        }(), be = {MathNode: xe, TextNode: ve, SpaceNode: ye, newDocumentFragment: ge}, we = function (t, e, r) {
            return !$[e][t] || !$[e][t].replace || 55349 === t.charCodeAt(0) || at.hasOwnProperty(t) && r && (r.fontFamily && "tt" === r.fontFamily.substr(4, 2) || r.font && "tt" === r.font.substr(4, 2)) || (t = $[e][t].replace), new be.TextNode(t)
        }, ke = function (t) {
            ...
            var a = t.text;
            return d.contains(["\\imath", "\\jmath"], a) ? null : ($[n][a] && $[n][a].replace && (a = $[n][a].replace), X(a, Vt.fontMap[r].fontName, n) ? Vt.fontMap[r].variant : null)
        }, Me = function (t, e) {
            for (var r = [], n = void 0, a = 0; a < t.length; a++) {
                ...
                if (o instanceof xe && n instanceof xe) {
                    ...
                    if ("mi" === o.type && 1 === o.children.length && "mn" === n.type) {
                        var h = o.children[0];
        ...
        var Ae = function (t) {
                return new zt({style: t.displayMode ? M.DISPLAY : M.TEXT, maxSize: t.maxSize})
            }, Be = function (t, e, r) {
                var n = Ae(r), a = function (t, e, r) {
                    var n = Me(t, r), a = void 0;
                    a = 1 === n.length && n[0] instanceof xe && d.contains(["mrow", "mtable"], n[0].type) ? n[0] : new be.MathNode("mrow", n);
                    var o = new be.MathNode("annotation", [new be.TextNode(e)]);
                    o.setAttribute("encoding", "application/x-tex");
                    var i = new be.MathNode("semantics", [a, o]), s = new be.MathNode("math", [i]);
                    return Vt.makeSpan(["katex-mathml"], [s])
                }(t, e, n), o = fe(t, n), i = Vt.makeSpan(["katex"], [a, o]);
                ...
                var a = void 0, o = t.height + t.depth + 2 * r;
                ...
                var r = function () {
                    ...
                    if (d.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                        var a = qe(t.base), o = void 0, i = void 0, s = void 0;
                        if (a > 5) "widehat" === n || "widecheck" === n ? (o = 420, r = 2364, s = .42, i = n + "4") : (o = 312, r = 2340, s = .34, i = "tilde4"); else {
                            var h = [1, 1, 2, 2, 3, 3][a];
                            "widehat" === n || "widecheck" === n ? (r = [0, 1062, 2364, 2364, 2364][h], o = [0, 239, 300, 360, 420][h], s = [0, .24, .3, .3, .36, .42][h], i = n + h) : (r = [0, 600, 1033, 2339, 2340][h], o = [0, 260, 286, 306, 312][h], s = [0, .26, .286, .3, .306, .34][h], i = "tilde" + h)
                        }
                        var l = new P(i), m = new D([l], {
                            width: "100%",
                            height: s + "em",
                            viewBox: "0 0 " + r + " " + o,
                            preserveAspectRatio: "none"
                        });
                        return {span: Vt.makeSvgSpan([], [m], e), minWidth: 0, height: s}
                    }
                    var c = [], p = Ne[n], u = p[0], f = p[1], g = p[2], x = g / 1e3, v = u.length, y = void 0, b = void 0;
                    if (1 === v) y = ["hide-tail"], b = [p[3]]; else if (2 === v) y = ["halfarrow-left", "halfarrow-right"], b = ["xMinYMin", "xMaxYMin"]; else {
                        if (3 !== v) throw new Error("Correct katexImagesData or update code here to support\n                    " + v + " children.");
                        y = ["brace-left", "brace-center", "brace-right"], b = ["xMinYMin", "xMidYMin", "xMaxYMin"]
                    }
                    for (var w = 0; w < v; w++) {
                        var k = new P(u[w]), S = new D([k], {
                            width: "400em",
                            height: x + "em",
                            viewBox: "0 0 " + r + " " + g,
                    ...
                    return {span: Vt.makeSpan(["stretchy"], c, e), minWidth: f, height: x}
                }(), n = r.span, a = r.minWidth, o = r.height;
                return n.height = o, n.style.height = o + "em", a > 0 && (n.style.minWidth = a + "em"), n
            }, Re = function (t, e) {
                var r = void 0, n = void 0, a = Ut(t, "supsub"), o = void 0;
                a ? (r = (n = Gt(a.base, "accent")).base, a.base = r, o = function (t) {
                    if (t instanceof I) return t;
                    throw new Error("Expected span<HtmlDomNode> but got " + String(t) + ".")
                }(ue(a, e)), a.base = n) : r = (n = Gt(t, "accent")).base;
                var i = ue(r, e.havingCrampedStyle()), s = 0;
                ...
                var l = Math.min(i.height, e.fontMetrics().xHeight), m = void 0;
                if (n.isStretchy) m = Ie(n, e), m = Vt.makeVList({
                    ...
                    "\\vec" === n.label ? (c = Vt.staticSvg("vec", e), p = Vt.svgData.vec[1]) : ((c = Vt.makeSymbol(n.label, "Main-Regular", n.mode, e)).italic = 0, p = c.width), m = Vt.makeSpan(["accent-body"], [c]);
                    var u = "\\textcircled" === n.label;
                    u && (m.classes.push("accent-full"), l = i.height);
                    var f = s;
                    u || (f -= p / 2), m.style.left = f + "em", "\\textcircled" === n.label && (m.style.top = ".2em"), m = Vt.makeVList({
                        positionType: "firstBaseline",
                        children: [{type: "elem", elem: i}, {type: "kern", size: -l}, {type: "elem", elem: m}]
                    }, e)
                }
                var g = Vt.makeSpan(["mord", "accent"], [m], e);
                return o ? (o.children[0] = g, o.height = Math.max(g.height, o.height), o.classes[0] = "mord", o) : g
            }, Le = function (t, e) {
                var r = t.isStretchy ? Oe(t.label) : new be.MathNode("mo", [we(t.label, t.mode)]),
        ...
        te({
            ...
            handler: function (t, e) {
                var r = e[0], n = !He.test(t.funcName),
            ...
            htmlBuilder: function (t, e) {
                var r = ue(t.base, e), n = Ie(t, e), a = "\\utilde" === t.label ? .12 : 0, o = Vt.makeVList({
                    positionType: "bottom",
            ...
            mathmlBuilder: function (t, e) {
                var r = Oe(t.label), n = new be.MathNode("munder", [Te(t.base, e), r]);
            ...
            htmlBuilder: function (t, e) {
                var r = e.style, n = e.havingStyle(r.sup()), a = ue(t.body, n, e);
                a.classes.push("x-arrow-pad");
                var o = void 0;
                t.below && (n = e.havingStyle(r.sub()), (o = ue(t.below, n, e)).classes.push("x-arrow-pad"));
                var i = Ie(t, e), s = -e.fontMetrics().axisHeight + .5 * i.height,
                    h = -e.fontMetrics().axisHeight - .5 * i.height - .111;
                (a.depth > .25 || "\\xleftequilibrium" === t.label) && (h -= a.depth);
                var l = void 0;
                if (o) {
                    var m = -e.fontMetrics().axisHeight + o.height + .5 * i.height + .111;
                    l = Vt.makeVList({
                        positionType: "individualShift",
                        children: [{type: "elem", elem: a, shift: h}, {type: "elem", elem: i, shift: s}, {
                            type: "elem",
                            elem: o,
                            shift: m
                        }]
                ...
                return l.children[0].children[0].children[1].classes.push("svg-align"), Vt.makeSpan(["mrel", "x-arrow"], [l], e)
            },
            mathmlBuilder: function (t, e) {
                var r = Oe(t.label), n = void 0, a = void 0;
                if (t.body) {
                    var o = Te(t.body, e);
                    t.below ? (a = Te(t.below, e), n = new be.MathNode("munderover", [r, a, o])) : n = new be.MathNode("mover", [r, o])
                } else t.below ? (a = Te(t.below, e), n = new be.MathNode("munder", [r, a])) : n = new be.MathNode("mover", [r]);
                return n
            }
        }), te({
            type: "textord", names: ["\\@char"], props: {numArgs: 1, allowedInText: !0}, handler: function (t, e) {
                for (var r = t.parser, n = Gt(e[0], "ordgroup").body, a = "", o = 0; o < n.length; o++) {
                    a += Gt(n[o], "textord").text
                }
                var i = parseInt(a);
                if (isNaN(i)) throw new h("\\@char has non-numeric argument " + a);
                return {type: "textord", mode: r.mode, text: String.fromCharCode(i)}
            }
        });
        var De = function (t, e) {
            ...
            var r = Me(t.body, e), n = new be.MathNode("mstyle", r);
        ...
        te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = Gt(e[0], "color-token").color, a = e[1];
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = e[0];
                return {type: "color", mode: r.mode, color: "katex-" + n.slice(1), body: re(a)}
            },
            htmlBuilder: De,
            mathmlBuilder: Pe
        }), te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.breakOnTokenText, a = Gt(e[0], "color-token").color,
            ...
            handler: function (t, e, r) {
                var n = t.parser, a = t.funcName, o = r[0], i = "\\cr" === a, s = !1;
            ...
            htmlBuilder: function (t, e) {
                if (t.newRow) throw new h("\\cr valid only within a tabular/array environment");
                var r = Vt.makeSpan(["mspace"], [], e);
                return t.newLine && (r.classes.push("newline"), t.size && (r.style.marginTop = Bt(t.size, e) + "em")), r
            },
            mathmlBuilder: function (t, e) {
                var r = new be.MathNode("mspace");
                return t.newLine && (r.setAttribute("linebreak", "newline"), t.size && r.setAttribute("height", Bt(t.size, e) + "em")), r
            }
        });
        var Fe = function (t, e, r) {
                ...
                var a = r.havingBaseStyle(e), o = Vt.makeSpan(n.concat(a.sizingClasses(r)), [t], r),
                ...
                }(t, e, a, n), s = Ve(Vt.makeSpan(["delimsizing", "size" + e], [i], n), M.TEXT, n, o);
                return r && Ge(s, n, M.TEXT), s
            }, Xe = function (t, e, r) {
                var n = void 0;
                return n = "Size1-Regular" === e ? "delim-size1" : "delim-size4", {
                    type: "elem",
                    elem: Vt.makeSpan(["delimsizinginner", n], [Vt.makeSpan([], [Vt.makeSymbol(t, e, r)])])
                }
            }, Ye = function (t, e, r, n, a, o) {
                var i = void 0, s = void 0, h = void 0, l = void 0;
                i = h = l = t, s = null;
                var m = "Size1-Regular";
                "\\uparrow" === t ? h = l = "\u23d0" : "\\Uparrow" === t ? h = l = "\u2016" : "\\downarrow" === t ? i = h = "\u23d0" : "\\Downarrow" === t ? i = h = "\u2016" : "\\updownarrow" === t ? (i = "\\uparrow", h = "\u23d0", l = "\\downarrow") : "\\Updownarrow" === t ? (i = "\\Uparrow", h = "\u2016", l = "\\Downarrow") : "[" === t || "\\lbrack" === t ? (i = "\u23a1", h = "\u23a2", l = "\u23a3", m = "Size4-Regular") : "]" === t || "\\rbrack" === t ? (i = "\u23a4", h = "\u23a5", l = "\u23a6", m = "Size4-Regular") : "\\lfloor" === t || "\u230a" === t ? (h = i = "\u23a2", l = "\u23a3", m = "Size4-Regular") : "\\lceil" === t || "\u2308" === t ? (i = "\u23a1", h = l = "\u23a2", m = "Size4-Regular") : "\\rfloor" === t || "\u230b" === t ? (h = i = "\u23a5", l = "\u23a6", m = "Size4-Regular") : "\\rceil" === t || "\u2309" === t ? (i = "\u23a4", h = l = "\u23a5", m = "Size4-Regular") : "(" === t ? (i = "\u239b", h = "\u239c", l = "\u239d", m = "Size4-Regular") : ")" === t ? (i = "\u239e", h = "\u239f", l = "\u23a0", m = "Size4-Regular") : "\\{" === t || "\\lbrace" === t ? (i = "\u23a7", s = "\u23a8", l = "\u23a9", h = "\u23aa", m = "Size4-Regular") : "\\}" === t || "\\rbrace" === t ? (i = "\u23ab", s = "\u23ac", l = "\u23ad", h = "\u23aa", m = "Size4-Regular") : "\\lgroup" === t || "\u27ee" === t ? (i = "\u23a7", l = "\u23a9", h = "\u23aa", m = "Size4-Regular") : "\\rgroup" === t || "\u27ef" === t ? (i = "\u23ab", l = "\u23ad", h = "\u23aa", m = "Size4-Regular") : "\\lmoustache" === t || "\u23b0" === t ? (i = "\u23a7", l = "\u23ad", h = "\u23aa", m = "Size4-Regular") : "\\rmoustache" !== t && "\u23b1" !== t || (i = "\u23ab", l = "\u23a9", h = "\u23aa", m = "Size4-Regular");
                var c = Fe(i, m, a), p = c.height + c.depth, u = Fe(h, m, a), d = u.height + u.depth, f = Fe(l, m, a),
                    g = f.height + f.depth, x = 0, v = 1;
                if (null !== s) {
                    var y = Fe(s, m, a);
                    x = y.height + y.depth, v = 2
                }
                var b = p + g + x, w = Math.ceil((e - b) / (v * d)), k = b + w * v * d, S = n.fontMetrics().axisHeight;
                r && (S *= n.sizeMultiplier);
                var z = k / 2 - S, T = [];
                if (T.push(Xe(l, m, a)), null === s) for (var A = 0; A < w; A++) T.push(Xe(h, m, a)); else {
                ...
                var N = n.havingBaseStyle(M.TEXT),
                    q = Vt.makeVList({positionType: "bottom", positionData: z, children: T}, N);
            ...
            We = ["(", ")", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230a", "\u230b", "\\lceil", "\\rceil", "\u2308", "\u2309", "\\surd"],
            je = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27ee", "\u27ef", "\\lmoustache", "\\rmoustache", "\u23b0", "\u23b1"],
            $e = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], Ze = [0, 1.2, 1.8, 2.4, 3],
            Ke = [{type: "small", style: M.SCRIPTSCRIPT}, {type: "small", style: M.SCRIPT}, {
                type: "small",
                style: M.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            Je = [{type: "small", style: M.SCRIPTSCRIPT}, {type: "small", style: M.SCRIPT}, {
                type: "small",
                style: M.TEXT
            }, {type: "stack"}], Qe = [{type: "small", style: M.SCRIPTSCRIPT}, {type: "small", style: M.SCRIPT}, {
                type: "small",
                style: M.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], tr = function (t) {
                ...
                for (var a = Math.min(2, 3 - n.style.size); a < r.length && "stack" !== r[a].type; a++) {
                    var o = Fe(t, tr(r[a]), "math"), i = o.height + o.depth;
                    if ("small" === r[a].type && (i *= n.havingBaseStyle(r[a].style).sizeMultiplier), i > e) return r[a]
                }
                return r[r.length - 1]
                ...
                var s = er(t, e, i, n);
                return "small" === s.type ? function (t, e, r, n, a, o) {
                    var i = Vt.makeSymbol(t, "Main-Regular", a, n), s = Ve(i, e, n, o);
                    return r && Ge(s, n, e), s
                }(t, s.style, r, n, a, o) : "large" === s.type ? Ue(t, s.size, r, n, a, o) : Ye(t, e, r, n, a, o)
            }, nr = function (t, e) {
                var r = e.havingBaseSizing(), n = er("\\surd", t * r.sizeMultiplier, Qe, r), a = r.sizeMultiplier,
                    o = void 0, i = 0, s = 0, h = 0, l = void 0;
                return "small" === n.type ? (h = 1080, t < 1 ? a = 1 : t < 1.4 && (a = .7), s = 1 / a, (o = _e("sqrtMain", i = 1.08 / a, h, e)).style.minWidth = "0.853em", l = .833 / a) : "large" === n.type ? (h = 1080 * Ze[n.size], s = Ze[n.size] / a, i = (Ze[n.size] + .08) / a, (o = _e("sqrtSize" + n.size, i, h, e)).style.minWidth = "1.02em", l = 1 / a) : (i = t + .08, s = t, h = Math.floor(1e3 * t) + 80, (o = _e("sqrtTall", i, h, e)).style.minWidth = "0.742em", l = 1.056), o.height = s, o.style.height = i + "em", {
                    span: o,
                    advanceWidth: l,
                    ruleWidth: e.fontMetrics().sqrtRuleThickness * a
                }
            }, ar = function (t, e, r, n, a) {
                if ("<" === t || "\\lt" === t || "\u27e8" === t ? t = "\\langle" : ">" !== t && "\\gt" !== t && "\u27e9" !== t || (t = "\\rangle"), d.contains(We, t) || d.contains($e, t)) return Ue(t, e, !1, r, n, a);
                if (d.contains(je, t)) return Ye(t, Ze[e], !1, r, n, a);
                throw new h("Illegal delimiter: '" + t + "'")
            }, or = rr, ir = function (t, e, r, n, a, o) {
                var i = n.fontMetrics().axisHeight * n.sizeMultiplier, s = 5 / n.fontMetrics().ptPerEm,
                    h = Math.max(e - i, r + i), l = Math.max(h / 500 * 901, 2 * h - s);
            ...
            hr = ["(", ")", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230a", "\u230b", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27e8", "\\rangle", "\u27e9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27ee", "\u27ef", "\\lmoustache", "\\rmoustache", "\u23b0", "\u23b1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];

        function lr(t, e) {
            var r = Yt(t);
            if (r && d.contains(hr, r.text)) return r;
            throw new h("Invalid delimiter: '" + (r ? r.text : JSON.stringify(t)) + "' after '" + e.funcName + "'", t)
        }
        ...
        te({
            ...
            htmlBuilder: function (t, e) {
                return "." === t.delim ? Vt.makeSpan([t.mclass]) : ar(t.delim, t.size, e, t.mode, [t.mclass])
            },
            ...
            type: "leftright-right", names: ["\\right"], props: {numArgs: 1}, handler: function (t, e) {
                return {type: "leftright-right", mode: t.parser.mode, delim: lr(e[0], t).text}
            }
        }), te({
            type: "leftright", names: ["\\left"], props: {numArgs: 1}, handler: function (t, e) {
                var r = lr(e[0], t), n = t.parser;
                ++n.leftrightDepth;
                var a = n.parseExpression(!1);
                --n.leftrightDepth, n.expect("\\right", !1);
                var o = n.parseFunction();
                if (!o) throw new h("failed to parse function after \\right");
                return {type: "leftright", mode: n.mode, body: a, left: r.text, right: Gt(o, "leftright-right").delim}
            }, htmlBuilder: function (t, e) {
                mr(t);
                for (var r = he(t.body, e, !0, [null, "mclose"]), n = 0, a = 0, o = !1, i = 0; i < r.length; i++) r[i].isMiddle ? o = !0 : (n = Math.max(r[i].height, n), a = Math.max(r[i].depth, a));
                n *= e.sizeMultiplier, a *= e.sizeMultiplier;
                var s = void 0;
                if (s = "." === t.left ? pe(e, ["mopen"]) : ir(t.left, n, a, e, t.mode, ["mopen"]), r.unshift(s), o) for (var h = 1; h < r.length; h++) {
                    var l = r[h].isMiddle;
                    l && (r[h] = ir(l.delim, n, a, l.options, t.mode, []))
                }
                var m = void 0;
                return m = "." === t.right ? pe(e, ["mclose"]) : ir(t.right, n, a, e, t.mode, ["mclose"]), r.push(m), Vt.makeSpan(["minner"], r, e)
            }, mathmlBuilder: function (t, e) {
                mr(t);
                var r = Me(t.body, e);
                if ("." !== t.left) {
            ...
            type: "middle", names: ["\\middle"], props: {numArgs: 1}, handler: function (t, e) {
                var r = lr(e[0], t);
                if (!t.parser.leftrightDepth) throw new h("\\middle without preceding \\left", r);
                return {type: "middle", mode: t.parser.mode, delim: r.text}
            }, htmlBuilder: function (t, e) {
                var r = void 0;
                if ("." === t.delim) r = pe(e, []); else {
        ...
        var cr = function (t, e) {
            var r = ue(t.body, e), n = t.label.substr(1), a = e.sizeMultiplier, o = void 0, i = 0,
                s = d.isCharacterBox(t.body);
            if ("sout" === n) (o = Vt.makeSpan(["stretchy", "sout"])).height = e.fontMetrics().defaultRuleThickness / a, i = -.5 * e.fontMetrics().xHeight; else {
                /cancel/.test(n) ? s || r.classes.push("cancel-pad") : r.classes.push("boxpad");
                var h = 0;
                h = /box/.test(n) ? "colorbox" === n ? .3 : .34 : s ? .2 : 0, o = Ee(r, n, h, e), i = r.depth + h, t.backgroundColor && (o.style.backgroundColor = t.backgroundColor, t.borderColor && (o.style.borderColor = t.borderColor))
            }
            var l = void 0;
            return l = t.backgroundColor ? Vt.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: o, shift: i}, {type: "elem", elem: r, shift: 0}]
            }, e) : Vt.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: r, shift: 0}, {
                    type: "elem",
                    elem: o,
                    shift: i,
                    wrapperClasses: /cancel/.test(n) ? ["svg-align"] : []
                }]
            }, e), /cancel/.test(n) && (l.height = r.height, l.depth = r.depth), /cancel/.test(n) && !s ? Vt.makeSpan(["mord", "cancel-lap"], [l], e) : Vt.makeSpan(["mord"], [l], e)
        }, pr = function (t, e) {
        ...
        te({
            ...
            handler: function (t, e, r) {
                var n = t.parser, a = t.funcName, o = Gt(e[0], "color-token").color, i = e[1];
                return {type: "enclose", mode: n.mode, label: a, backgroundColor: o, body: i}
            },
            htmlBuilder: cr,
            mathmlBuilder: pr
        }), te({
            ...
            handler: function (t, e, r) {
                var n = t.parser, a = t.funcName, o = Gt(e[0], "color-token").color, i = Gt(e[1], "color-token").color,
                    s = e[2];
                return {type: "enclose", mode: n.mode, label: a, backgroundColor: i, borderColor: o, body: s}
            },
            htmlBuilder: cr,
            mathmlBuilder: pr
        }), te({
            ...
            props: {numArgs: 1},
            handler: function (t, e, r) {
                var n = t.parser, a = t.funcName, o = e[0];
            ...
            handler: function (t, e) {
                ...
                if ("ordgroup" !== n.type) throw new h("Invalid environment name", n);
                for (var a = "", o = 0; o < n.body.length; ++o) a += Gt(n.body[o], "textord").text;
        ...
        te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = e[0];
                return {type: "mclass", mode: r.mode, mclass: "m" + n.substr(5), body: re(a)}
            },
            htmlBuilder: dr,
            mathmlBuilder: fr
        });
        ...
        te({
            type: "mclass", names: ["\\@binrel"], props: {numArgs: 2}, handler: function (t, e) {
                return {type: "mclass", mode: t.parser.mode, mclass: gr(e[0]), body: [e[1]]}
            }
        }), te({
            type: "mclass",
            ...
            props: {numArgs: 2},
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = e[1], o = e[0], i = void 0;
        ...
        var xr = function (t, e) {
            ...
            var r = t.font, n = e.withFont(r);
            return Te(t.body, n)
        }, yr = {"\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol"};
        te({
            type: "font",
            names: ["\\mathrm", "\\mathit", "\\mathbf", "\\mathbb", "\\mathcal", "\\mathfrak", "\\mathscr", "\\mathsf", "\\mathtt", "\\Bbb", "\\bold", "\\frak"],
            props: {numArgs: 1, greediness: 2},
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = e[0], o = n;
                return o in yr && (o = yr[o]), {type: "font", mode: r.mode, font: o.slice(1), body: a}
            },
            htmlBuilder: xr,
            mathmlBuilder: vr
        }), te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = t.breakOnTokenText, o = r.mode;
                r.consumeSpaces();
        ...
        var br = function (t, e) {
            var r = e.style;
            "display" === t.size ? r = M.DISPLAY : "text" === t.size && r.size === M.DISPLAY.size ? r = M.TEXT : "script" === t.size ? r = M.SCRIPT : "scriptscript" === t.size && (r = M.SCRIPTSCRIPT);
            var n = r.fracNum(), a = r.fracDen(), o = void 0;
            o = e.havingStyle(n);
            var i = ue(t.numer, o, e);
            if (t.continued) {
                var s = 8.5 / e.fontMetrics().ptPerEm, h = 3.5 / e.fontMetrics().ptPerEm;
                i.height = i.height < s ? s : i.height, i.depth = i.depth < h ? h : i.depth
            }
            o = e.havingStyle(a);
            var l = ue(t.denom, o, e), m = void 0, c = void 0, p = void 0;
            t.hasBarLine ? (t.barSize ? (c = Bt(t.barSize, e), m = Vt.makeLineSpan("frac-line", e, c)) : m = Vt.makeLineSpan("frac-line", e), c = m.height, p = m.height) : (m = null, c = 0, p = e.fontMetrics().defaultRuleThickness);
            var u = void 0, d = void 0, f = void 0;
            r.size === M.DISPLAY.size ? (u = e.fontMetrics().num1, d = c > 0 ? 3 * p : 7 * p, f = e.fontMetrics().denom1) : (c > 0 ? (u = e.fontMetrics().num2, d = p) : (u = e.fontMetrics().num3, d = 3 * p), f = e.fontMetrics().denom2);
            var g = void 0;
            if (m) {
                var x = e.fontMetrics().axisHeight;
                u - i.depth - (x + .5 * c) < d && (u += d - (u - i.depth - (x + .5 * c))), x - .5 * c - (l.height - f) < d && (f += d - (x - .5 * c - (l.height - f)));
                var v = -(x - .5 * c);
                g = Vt.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: l, shift: f}, {type: "elem", elem: m, shift: v}, {
                        type: "elem",
                        elem: i,
                        shift: -u
                    }]
                ...
                y < d && (u += .5 * (d - y), f += .5 * (d - y)), g = Vt.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: l, shift: f}, {type: "elem", elem: i, shift: -u}]
                }, e)
            }
            o = e.havingStyle(r), g.height *= o.sizeMultiplier / e.sizeMultiplier, g.depth *= o.sizeMultiplier / e.sizeMultiplier;
            var b = void 0;
            b = r.size === M.DISPLAY.size ? e.fontMetrics().delim1 : e.fontMetrics().delim2;
            var w = void 0, k = void 0;
            return w = null == t.leftDelim ? pe(e, ["mopen"]) : or(t.leftDelim, b, !0, e.havingStyle(r), t.mode, ["mopen"]), k = t.continued ? Vt.makeSpan([]) : null == t.rightDelim ? pe(e, ["mclose"]) : or(t.rightDelim, b, !0, e.havingStyle(r), t.mode, ["mclose"]), Vt.makeSpan(["mord"].concat(o.sizingClasses(e)), [w, Vt.makeSpan(["mfrac"], [g]), k], e)
        }, wr = function (t, e) {
        ...
        te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = e[0], o = e[1], i = void 0, s = null, h = null, l = "auto";
                switch (n) {
                    case"\\cfrac":
                    case"\\dfrac":
                    case"\\frac":
            ...
            handler: function (t) {
                var e = t.parser, r = t.funcName, n = t.token, a = void 0;
                switch (r) {
                    case"\\over":
                        a = "\\frac";
                        break;
        ...
        var kr = ["display", "text", "script", "scriptscript"], Sr = function (t) {
            var e = null;
        ...
        te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = e[4], a = e[5], o = Ut(e[0], "ordgroup");
                o = Xt(o ? o.body[0] : e[0], "open");
                var i = Sr(o.text), s = Ut(e[1], "ordgroup");
                s = Xt(s ? s.body[0] : e[1], "close");
                var h = Sr(s.text), l = Gt(e[2], "size"), m = void 0, c = null;
                m = !!l.isBlank || (c = l.value).number > 0;
                var p = "auto", u = Ut(e[3], "ordgroup");
                if (u) {
                    if (u.body.length > 0) {
            ...
            handler: function (t, e) {
                var r = t.parser, n = (t.funcName, e[0]), a = u(Gt(e[1], "infix").size), o = e[2], i = a.number > 0;
                return {
                    type: "genfrac",
                    mode: r.mode,
                    numer: n,
        ...
        var Mr = function (t, e) {
            var r = e.style, n = void 0, a = void 0, o = Ut(t, "supsub");
            o ? (n = o.sup ? ue(o.sup, e.havingStyle(r.sup()), e) : ue(o.sub, e.havingStyle(r.sub()), e), a = Gt(o.base, "horizBrace")) : a = Gt(t, "horizBrace");
            var i = ue(a.base, e.havingBaseStyle(M.DISPLAY)), s = Ie(a, e), h = void 0;
            if (a.isOver ? (h = Vt.makeVList({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: i}, {type: "kern", size: .1}, {type: "elem", elem: s}]
            }, e)).children[0].children[0].children[1].classes.push("svg-align") : (h = Vt.makeVList({
                positionType: "bottom",
                positionData: i.depth + .1 + s.height,
                children: [{type: "elem", elem: s}, {type: "kern", size: .1}, {type: "elem", elem: i}]
            }, e)).children[0].children[0].children[0].classes.push("svg-align"), n) {
                var l = Vt.makeSpan(["mord", a.isOver ? "mover" : "munder"], [h], e);
                h = a.isOver ? Vt.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: l}, {type: "kern", size: .2}, {type: "elem", elem: n}]
                }, e) : Vt.makeVList({
                    positionType: "bottom",
                    positionData: l.depth + .2 + n.height + n.depth,
                    children: [{type: "elem", elem: n}, {type: "kern", size: .2}, {type: "elem", elem: l}]
                }, e)
            }
        ...
        te({
            ...
            }, htmlBuilder: Mr, mathmlBuilder: function (t, e) {
                var r = Oe(t.label);
                return new be.MathNode(t.isOver ? "mover" : "munder", [Te(t.base, e), r])
            }
        }), te({
            type: "href",
            names: ["\\href"],
            ...
            handler: function (t, e) {
                var r = t.parser, n = e[1], a = Gt(e[0], "url").url;
            ...
            mathmlBuilder: function (t, e) {
                ...
                return function (t, e) {
                    ...
                    var r = String(e.name || e), n = String(t.constructor.name || t);
                    throw new Error("Expected " + r + " but got " + n + ".")
                }(r, xe).setAttribute("href", t.href), r
            }
        }), te({
            type: "href",
            names: ["\\url"],
            ...
            handler: function (t, e) {
                for (var r = t.parser, n = Gt(e[0], "url").url, a = [], o = 0; o < n.length; o++) {
                    var i = n[o];
                    "~" === i && (i = "\\textasciitilde"), a.push({type: "textord", mode: "text", text: i})
                }
            ...
            handler: function (t, e) {
                return {type: "htmlmathml", mode: t.parser.mode, html: re(e[0]), mathml: re(e[1])}
            },
            htmlBuilder: function (t, e) {
                var r = he(t.html, e, !1);
                return Vt.makeFragment(r)
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName, a = Gt(e[0], "size");
                if (r.settings.strict) {
                    var o = "m" === n[1], i = "mu" === a.value.unit;
                    o ? (i || r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " supports only mu units, not " + a.value.unit + " units"), "math" !== r.mode && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " works only in math mode")) : i && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " doesn't support mu units")
                }
            ...
            htmlBuilder: function (t, e) {
                var r = void 0;
                "clap" === t.alignment ? (r = Vt.makeSpan([], [ue(t.body, e)]), r = Vt.makeSpan(["inner"], [r], e)) : r = Vt.makeSpan(["inner"], [ue(t.body, e)]);
                var n = Vt.makeSpan(["fix"], []), a = Vt.makeSpan([t.alignment], [r, n], e), o = Vt.makeSpan(["strut"]);
                return o.style.height = a.height + a.depth + "em", o.style.verticalAlign = -a.depth + "em", a.children.unshift(o), a = Vt.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: a}]
                }, e), Vt.makeSpan(["mord"], [a], e)
            },
            mathmlBuilder: function (t, e) {
            ...
            handler: function (t, e) {
                ...
                n.switchMode("math");
                var o = "\\(" === r ? "\\)" : "$", i = n.parseExpression(!1, o);
                return n.expect(o, !1), n.switchMode(a), n.consume(), {
                    type: "styling",
                    mode: n.mode,
                    style: "text",
                    body: i
        ...
        var Tr = function (t, e) {
            var r = void 0, n = void 0, a = !1, o = void 0, i = Ut(t, "supsub");
            i ? (r = i.sup, n = i.sub, o = Gt(i.base, "op"), a = !0) : o = Gt(t, "op");
            var s = e.style, h = !1;
            s.size === M.DISPLAY.size && o.symbol && !d.contains(["\\smallint"], o.name) && (h = !0);
            var l = void 0;
            if (o.symbol) {
                var m = h ? "Size2-Regular" : "Size1-Regular", c = "";
                if ("\\oiint" !== o.name && "\\oiiint" !== o.name || (c = o.name.substr(1), o.name = "oiint" === c ? "\\iint" : "\\iiint"), l = Vt.makeSymbol(o.name, m, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]), c.length > 0) {
                    var p = l.italic, u = Vt.staticSvg(c + "Size" + (h ? "2" : "1"), e);
                    l = Vt.makeVList({
                        positionType: "individualShift",
                        children: [{type: "elem", elem: l, shift: 0}, {type: "elem", elem: u, shift: h ? .08 : 0}]
                    }, e), o.name = "\\" + c, l.classes.unshift("mop"), l.italic = p
                }
            } else if (o.body) {
                var f = he(o.body, e, !0);
                1 === f.length && f[0] instanceof H ? (l = f[0]).classes[0] = "mop" : l = Vt.makeSpan(["mop"], f, e)
            } else {
                for (var g = [], x = 1; x < o.name.length; x++) g.push(Vt.mathsym(o.name[x], o.mode));
                l = Vt.makeSpan(["mop"], g, e)
            }
            var v = 0, y = 0;
            if ((l instanceof H || "\\oiint" === o.name || "\\oiiint" === o.name) && !o.suppressBaseShift && (v = (l.height - l.depth) / 2 - e.fontMetrics().axisHeight, y = l.italic), a) {
                l = Vt.makeSpan([], [l]);
                ...
                if (r) {
                    ...
                    w = {
                        elem: k,
                        kern: Math.max(e.fontMetrics().bigOpSpacing1, e.fontMetrics().bigOpSpacing3 - k.depth)
                    }
                }
                if (n) {
                    ...
                    b = {
                        elem: S,
                        kern: Math.max(e.fontMetrics().bigOpSpacing2, e.fontMetrics().bigOpSpacing4 - S.height)
                    }
                }
                var z = void 0;
                if (w && b) {
                    var T = e.fontMetrics().bigOpSpacing5 + b.elem.height + b.elem.depth + b.kern + l.depth + v;
                    z = Vt.makeVList({
                        positionType: "bottom",
                        positionData: T,
                        children: [{type: "kern", size: e.fontMetrics().bigOpSpacing5}, {
                            ...
                            elem: b.elem,
                            marginLeft: -y + "em"
                        }, {type: "kern", size: b.kern}, {type: "elem", elem: l}, {
                            type: "kern",
                            size: w.kern
                    ...
                    z = Vt.makeVList({
                        positionType: "bottom",
                        positionData: B,
                        children: [{type: "elem", elem: l}, {type: "kern", size: w.kern}, {
                            type: "elem",
                            elem: w.elem,
                            marginLeft: y + "em"
            ...
            return v && (l.style.position = "relative", l.style.top = v + "em"), l
        }, Ar = function (t, e) {
            var r = void 0;
            if (t.symbol) r = new xe("mo", [we(t.name, t.mode)]); else {
                if (!t.body) return ge([r = new xe("mi", [new ve(t.name.slice(1))]), new xe("mo", [we("\u2061", "text")])]);
        ...
        te({
            ...
            handler: function (t, e) {
                var r = t.parser, n = t.funcName;
                return 1 === n.length && (n = Br[n]), {type: "op", mode: r.mode, limits: !0, symbol: !0, name: n}
            },
            htmlBuilder: Tr,
            mathmlBuilder: Ar
        }), te({
            type: "op", names: ["\\mathop"], props: {numArgs: 1}, handler: function (t, e) {
                var r = t.parser, n = e[0];
                return {type: "op", mode: r.mode, limits: !1, symbol: !1, body: re(n)}
            }, htmlBuilder: Tr, mathmlBuilder: Ar
        });
        var Cr = {
            "\u222b": "\\int",
            "\u222c": "\\iint",
        ...
        function Nr(t, e, r) {
            for (var n = he(t, e, !1), a = e.sizeMultiplier / r.sizeMultiplier, o = 0; o < n.length; o++) {
                var i = n[o].classes.indexOf("sizing");
                i < 0 ? Array.prototype.push.apply(n[o].classes, e.sizingClasses(r)) : n[o].classes[i + 1] === "reset-size" + e.size && (n[o].classes[i + 1] = "reset-size" + r.size), n[o].height *= a, n[o].depth *= a
            }
            return Vt.makeFragment(n)
        }
        ...
        te({
            ...
            handler: function (t) {
                var e = t.parser, r = t.funcName;
                return 1 === r.length && (r = Cr[r]), {type: "op", mode: e.mode, limits: !1, symbol: !0, name: r}
            },
            htmlBuilder: Tr,
            mathmlBuilder: Ar
        }), te({
            type: "operatorname", names: ["\\operatorname"], props: {numArgs: 1}, handler: function (t, e) {
                ...
                if (t.body.length > 0) {
                    ...
                    }), n = he(r, e.withFont("mathrm"), !0), a = 0; a < n.length; a++) {
                        var o = n[a];
                        o instanceof H && (o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
                    }
                    return Vt.makeSpan(["mop"], n, e)
                }
                return Vt.makeSpan(["mop"], [], e)
            }, mathmlBuilder: function (t, e) {
                for (var r = Me(t.body, e.withFont("mathrm")), n = !0, a = 0; a < r.length; a++) {
                    var o = r[a];
                    if (o instanceof be.SpaceNode) ; else if (o instanceof be.MathNode) switch (o.type) {
                        case"mi":
                        case"mn":
                        case"ms":
                        case"mspace":
                        ...
                        case"mo":
                            var i = o.children[0];
                            1 === o.children.length && i instanceof be.TextNode ? i.text = i.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                            break;
                        default:
                            n = !1
                    } else n = !1
            ...
            type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler: function (t, e) {
                ...
                var r = ue(t.body, e.havingCrampedStyle()), n = Vt.makeLineSpan("overline-line", e), a = Vt.makeVList({
                    positionType: "firstBaseline",
            ...
            htmlBuilder: function (t, e) {
                ...
                return r = Vt.makeVList({positionType: "firstBaseline", children: [{type: "elem", elem: r}]}, e)
            },
            mathmlBuilder: function (t, e) {
                var r = Me(re(t.body), e), n = new be.MathNode("mphantom", r);
            ...
            htmlBuilder: function (t, e) {
                var r = Vt.makeSpan(["inner"], [ue(t.body, e.withPhantom())]), n = Vt.makeSpan(["fix"], []);
        ...
        var qr = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"],
            Er = function (t, e) {
                var r = e.havingSize(t.size);
                return Nr(t.body, r, e)
            };
        te({
            type: "sizing", names: qr, props: {numArgs: 0, allowedInText: !0}, handler: function (t, e) {
                var r = t.breakOnTokenText, n = t.funcName, a = t.parser;
                a.consumeSpaces();
                var o = a.parseExpression(!1, r);
                return {type: "sizing", mode: a.mode, size: qr.indexOf(n) + 1, body: o}
            }, htmlBuilder: Er, mathmlBuilder: function (t, e) {
                var r = e.havingSize(t.size), n = Me(t.body, r), a = new be.MathNode("mstyle", n);
            ...
            handler: function (t, e) {
                var r = t.parser, n = Gt(e[0], "size").value, a = e[1];
                return {type: "raisebox", mode: r.mode, dy: n, body: a}
            },
            htmlBuilder: function (t, e) {
                var r = {type: "text", mode: t.mode, body: re(t.body), font: "mathrm"},
                    n = {type: "sizing", mode: t.mode, body: [r], size: 6}, a = Er(n, e), o = Bt(t.dy, e);
                return Vt.makeVList({positionType: "shift", positionData: -o, children: [{type: "elem", elem: a}]}, e)
            },
            mathmlBuilder: function (t, e) {
                var r = new be.MathNode("mpadded", [Te(t.body, e)]), n = t.dy.number + t.dy.unit;
            ...
            handler: function (t, e, r) {
                var n = t.parser, a = r[0], o = Gt(e[0], "size"), i = Gt(e[1], "size");
                return {type: "rule", mode: n.mode, shift: a && Gt(a, "size").value, width: o.value, height: i.value}
            },
            htmlBuilder: function (t, e) {
                var r = Vt.makeSpan(["mord", "rule"], [], e), n = 0;
                t.shift && (n = Bt(t.shift, e));
                var a = Bt(t.width, e), o = Bt(t.height, e);
                return r.style.borderRightWidth = a + "em", r.style.borderTopWidth = o + "em", r.style.bottom = n + "em", r.width = a, r.height = o + n, r.depth = -n, r.maxFontSize = 1.125 * o * e.sizeMultiplier, r
            },
            mathmlBuilder: function (t, e) {
            ...
            handler: function (t, e, r) {
                var n = t.parser, a = !1, o = !1, i = r[0] && Gt(r[0], "ordgroup");
                if (i) for (var s = "", h = 0; h < i.body.length; ++h) {
                    if ("t" === (s = i.body[h].text)) a = !0; else {
                        if ("b" !== s) {
                            a = !1, o = !1;
                            break
                        }
                ...
                var l = e[0];
                return {type: "smash", mode: n.mode, body: l, smashHeight: a, smashDepth: o}
            },
            htmlBuilder: function (t, e) {
                ...
                return Vt.makeVList({positionType: "firstBaseline", children: [{type: "elem", elem: r}]}, e)
            },
            mathmlBuilder: function (t, e) {
                var r = new be.MathNode("mpadded", [Te(t.body, e)]);
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler: function (t, e, r) {
                ...
                if (t.index) {
                    var d = e.havingStyle(M.SCRIPTSCRIPT), f = ue(t.index, d, e), g = .6 * (u.height - u.depth),
                        x = Vt.makeVList({
                            positionType: "shift",
                            positionData: -g,
                            children: [{type: "elem", elem: f}]
                        }, e), v = Vt.makeSpan(["root"], [x]);
                    return Vt.makeSpan(["mord", "sqrt"], [v, u], e)
                }
                return Vt.makeSpan(["mord", "sqrt"], [u], e)
            }, mathmlBuilder: function (t, e) {
                var r = t.body, n = t.index;
                return n ? new be.MathNode("mroot", [Te(r, e), Te(n, e)]) : new be.MathNode("msqrt", [Te(r, e)])
            }
        });
        var Or = {display: M.DISPLAY, text: M.TEXT, script: M.SCRIPT, scriptscript: M.SCRIPTSCRIPT};
        te({
            type: "styling",
            ...
            handler: function (t, e) {
                var r = t.breakOnTokenText, n = t.funcName, a = t.parser;
                a.consumeSpaces();
                var o = a.parseExpression(!0, r), i = n.slice(1, n.length - 5);
                return {type: "styling", mode: a.mode, style: i, body: o}
            },
            htmlBuilder: function (t, e) {
                var r = Or[t.style], n = e.havingStyle(r).withFont("");
                return Nr(t.body, n, e)
            },
            mathmlBuilder: function (t, e) {
                var r = {display: M.DISPLAY, text: M.TEXT, script: M.SCRIPT, scriptscript: M.SCRIPTSCRIPT}[t.style],
                    n = e.havingStyle(r), a = Me(t.body, n), o = new be.MathNode("mstyle", a), i = {
                        display: ["0", "true"],
                        text: ["0", "false"],
                        script: ["1", "false"],
        ...
        ee({
            type: "supsub", htmlBuilder: function (t, e) {
                var r = function (t, e) {
                    var r = t.base;
                    return r ? "op" === r.type ? r.limits && (e.style.size === M.DISPLAY.size || r.alwaysHandleSupSub) ? Tr : null : "accent" === r.type ? d.isCharacterBox(r.base) ? Re : null : "horizBrace" === r.type && !t.sub === r.isOver ? Mr : null : null
                }(t, e);
                if (r) return r(t, e);
                var n = t.base, a = t.sup, o = t.sub, i = ue(n, e), s = void 0, h = void 0, l = e.fontMetrics(), m = 0,
                    c = 0, p = n && d.isCharacterBox(n);
                if (a) {
                    var u = e.havingStyle(e.style.sup());
                    s = ue(a, u, e), p || (m = i.height - u.fontMetrics().supDrop * u.sizeMultiplier / e.sizeMultiplier)
                }
                if (o) {
                    var f = e.havingStyle(e.style.sub());
                    h = ue(o, f, e), p || (c = i.depth + f.fontMetrics().subDrop * f.sizeMultiplier / e.sizeMultiplier)
                }
                var g = void 0;
                g = e.style === M.DISPLAY ? l.sup1 : e.style.cramped ? l.sup3 : l.sup2;
                var x = e.sizeMultiplier, v = .5 / l.ptPerEm / x + "em", y = null;
                if (h) {
                ...
                var w = void 0;
                if (s && h) {
                    m = Math.max(m, g, s.depth + .25 * l.xHeight), c = Math.max(c, l.sub2);
                    var k = 4 * l.defaultRuleThickness;
                    if (m - s.depth - (h.height - c) < k) {
                        c = k - (m - s.depth) + h.height;
                        var S = .8 * l.xHeight - (m - s.depth);
                        S > 0 && (m += S, c -= S)
                    }
                    var z = [{type: "elem", elem: h, shift: c, marginRight: v, marginLeft: y}, {
                        type: "elem",
                        elem: s,
                        shift: -m,
                        marginRight: v
                    }];
                    w = Vt.makeVList({positionType: "individualShift", children: z}, e)
                } else if (h) {
                    c = Math.max(c, l.sub1, h.height - .8 * l.xHeight);
                    var T = [{type: "elem", elem: h, marginLeft: y, marginRight: v}];
                    w = Vt.makeVList({positionType: "shift", positionData: c, children: T}, e)
                } else {
                    if (!s) throw new Error("supsub must have either sup or sub.");
                    m = Math.max(m, g, s.depth + .25 * l.xHeight), w = Vt.makeVList({
                        positionType: "shift",
                        positionData: -m,
                ...
                var r = !1, n = void 0, a = Ut(t.base, "horizBrace");
                a && !!t.sup === a.isOver && (r = !0, n = a.isOver);
                var o = [Te(t.base, e)];
                t.sub && o.push(Te(t.sub, e)), t.sup && o.push(Te(t.sup, e));
                var i = void 0;
                if (r) i = n ? "mover" : "munder"; else if (t.sub) if (t.sup) {
                    var s = t.base;
                    i = s && "op" === s.type && s.limits && e.style === M.DISPLAY ? "munderover" : "msubsup"
                } else {
                    var h = t.base;
                    i = h && "op" === h.type && h.limits && e.style === M.DISPLAY ? "munder" : "msub"
                } else {
                    var l = t.base;
                    i = l && "op" === l.type && l.limits && e.style === M.DISPLAY ? "mover" : "msup"
                }
        ...
        ee({
            type: "mathord", htmlBuilder: function (t, e) {
                ...
                var r = new be.MathNode("mi", [we(t.text, t.mode, e)]), n = Se(t, e) || "italic";
            ...
            type: "textord", htmlBuilder: function (t, e) {
                ...
                var r = we(t.text, t.mode, e), n = Se(t, e) || "normal", a = void 0;
                return a = "text" === t.mode ? new be.MathNode("mtext", [r]) : /[0-9]/.test(t.text) ? new be.MathNode("mn", [r]) : "\\prime" === t.text ? new be.MathNode("mo", [r]) : new be.MathNode("mi", [r]), n !== Ir[a.type] && a.setAttribute("mathvariant", n), a
            }
        }), ee({
            type: "spacing", htmlBuilder: function (t, e) {
                if (Vt.regularSpace.hasOwnProperty(t.text)) {
                    ...
                    return Vt.makeSpan(["mspace", r], [Vt.mathsym(t.text, t.mode, e)], e)
                }
                if (Vt.cssSpace.hasOwnProperty(t.text)) return Vt.makeSpan(["mspace", Vt.cssSpace[t.text]], [], e);
                throw new h('Unknown type of space "' + t.text + '"')
            }, mathmlBuilder: function (t, e) {
                if (!Vt.regularSpace.hasOwnProperty(t.text)) {
                    if (Vt.cssSpace.hasOwnProperty(t.text)) return new be.MathNode("mspace");
                    throw new h('Unknown type of space "' + t.text + '"')
                }
            ...
            type: "tag", mathmlBuilder: function (t, e) {
                var r = new be.MathNode("mtable", [new be.MathNode("mlabeledtr", [new be.MathNode("mtd", [ze(t.tag, e)]), new be.MathNode("mtd", [ze(t.body, e)])])]);
        ...
        var Rr = {
            ...
            "\\texttt": "texttt",
            "\\textnormal": "textrm"
        }, Lr = {"\\textbf": "textbf"}, Hr = {"\\textit": "textit"}, Dr = function (t, e) {
            var r = t.font;
            return r ? Rr[r] ? e.withTextFontFamily(Rr[r]) : Lr[r] ? e.withTextFontWeight(Lr[r]) : e.withTextFontShape(Hr[r]) : e
        };
        te({
            type: "text",
            ...
            htmlBuilder: function (t, e) {
                var r = ue(t.body, e), n = Vt.makeLineSpan("underline-line", e), a = Vt.makeVList({
                    positionType: "top",
            ...
            type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler: function (t, e, r) {
                ...
                for (var r = Vt.makeVerb(t, e), n = [], a = e.havingStyle(e.style.text()), o = 0; o < r.length; o++) {
                    var i = r[o];
                    "~" === i && (i = "\\textasciitilde"), n.push(Vt.makeSymbol(i, "Typewriter-Regular", t.mode, a, ["mord", "texttt"]))
                }
                return Vt.tryCombineChars(n), Vt.makeSpan(["mord", "text"].concat(a.sizingClasses(e)), n, a)
            }, mathmlBuilder: function (t, e) {
                var r = new be.TextNode(Vt.makeVerb(t, e)), n = new be.MathNode("mtext", [r]);
        ...
        function Vr(t) {
            for (var e = t.type, r = t.names, n = t.props, a = t.handler, o = t.htmlBuilder, i = t.mathmlBuilder, s = {
                type: e,
                numArgs: n.numArgs || 0,
                greediness: 1,
                allowedInText: !1,
        ...
        function Ur(t, e, r) {
            var n = e.hskipBeforeAndAfter, a = e.addJot, o = e.cols, i = e.arraystretch;
            if (t.gullet.beginGroup(), t.gullet.macros.set("\\\\", "\\cr"), !i) {
                var s = t.gullet.expandMacroAsText("\\arraystretch");
                if (null == s) i = 1; else if (!(i = parseFloat(s)) || i < 0) throw new h("Invalid \\arraystretch: " + s)
            }
            var l = [], m = [l], c = [], p = [];
            for (p.push(Gr(t)); ;) {
                var u = t.parseExpression(!1, "\\cr");
                u = {type: "ordgroup", mode: t.mode, body: u}, r && (u = {
                    type: "styling",
                    mode: t.mode,
                    style: r,
                    body: [u]
                ...
                if ("&" === d) t.consume(); else {
                    if ("\\end" === d) {
                        1 === l.length && "styling" === u.type && 0 === u.body[0].body.length && m.pop(), p.length < m.length + 1 && p.push([]);
                        break
                    }
                    if ("\\cr" !== d) throw new h("Expected & or \\\\ or \\cr or \\end", t.nextToken);
        ...
        var Yr = function (t, e) {
            var r = void 0, n = void 0, a = t.body.length, o = t.hLinesBeforeRow, i = 0, s = new Array(a), l = [],
                m = 1 / e.fontMetrics().ptPerEm, c = 5 * m, p = 12 * m, u = 3 * m, f = t.arraystretch * p, g = .7 * f,
                x = .3 * f, v = 0;
            ...
            for (y(o[0]), r = 0; r < t.body.length; ++r) {
                ...
                for (n = 0; n < b.length; ++n) {
                    var M = ue(b[n], e);
                    k < M.depth && (k = M.depth), w < M.height && (w = M.height), S[n] = M
                }
                var z = t.rowGaps[r], T = 0;
                z && (T = Bt(z, e)) > 0 && (k < (T += x) && (k = T), T = 0), t.addJot && (k += u), S.height = w, S.depth = k, v += w, S.pos = v, v += k + T, s[r] = S, y(o[r + 1])
            }
            var A = v / 2 + e.fontMetrics().axisHeight, B = t.cols || [], C = [], N = void 0, q = void 0;
            for (n = 0, q = 0; n < i || q < B.length; ++n, ++q) {
                for (var E = B[q] || {}, O = !0; "separator" === E.type;) {
                    if (O || ((N = Vt.makeSpan(["arraycolsep"], [])).style.width = e.fontMetrics().doubleRuleSep + "em", C.push(N)), "|" === E.separator) {
                        var I = Vt.makeSpan(["vertical-separator"], [], e);
                        I.style.height = v + "em", I.style.verticalAlign = -(v - A) + "em", C.push(I)
                    } else {
                        if (":" !== E.separator) throw new h("Invalid separator type: " + E.separator);
                        var R = Vt.makeSpan(["vertical-separator", "vs-dashed"], [], e);
                        R.style.height = v + "em", R.style.verticalAlign = -(v - A) + "em", C.push(R)
                    }
                    E = B[++q] || {}, O = !1
                }
                if (!(n >= i)) {
                    var L = void 0;
                    (n > 0 || t.hskipBeforeAndAfter) && 0 !== (L = d.deflt(E.pregap, c)) && ((N = Vt.makeSpan(["arraycolsep"], [])).style.width = L + "em", C.push(N));
                    var H = [];
                    for (r = 0; r < a; ++r) {
                        var D = s[r], P = D[n];
                        if (P) {
                            var F = D.pos - A;
                            P.depth = D.depth, P.height = D.height, H.push({type: "elem", elem: P, shift: F})
                        }
                    }
                    H = Vt.makeVList({
                        positionType: "individualShift",
                        children: H
                    }, e), H = Vt.makeSpan(["col-align-" + (E.align || "c")], [H]), C.push(H), (n < i - 1 || t.hskipBeforeAndAfter) && 0 !== (L = d.deflt(E.postgap, c)) && ((N = Vt.makeSpan(["arraycolsep"], [])).style.width = L + "em", C.push(N))
                }
            }
            if (s = Vt.makeSpan(["mtable"], C), l.length > 0) {
                for (var V = Vt.makeLineSpan("hline", e, .05), G = Vt.makeLineSpan("hdashline", e, .05), U = [{
                    type: "elem",
                    elem: s,
                    shift: 0
                }]; l.length > 0;) {
                    var X = l.pop(), Y = X.pos - A;
                    X.isDashed ? U.push({type: "elem", elem: G, shift: Y}) : U.push({type: "elem", elem: V, shift: Y})
                }
                s = Vt.makeVList({positionType: "individualShift", children: U}, e)
            }
            return Vt.makeSpan(["mord"], [s], e)
        }, _r = function (t, e) {
            return new be.MathNode("mtable", t.body.map(function (t) {
                return new be.MathNode("mtr", t.map(function (t) {
                    return new be.MathNode("mtd", [Te(t, e)])
                }))
            }))
        }, Wr = function (t, e) {
            var r = [], n = Ur(t.parser, {cols: r, addJot: !0}, "display"), a = void 0, o = 0,
                i = {type: "ordgroup", mode: t.mode, body: []}, s = Ut(e[0], "ordgroup");
            if (s) {
            ...
            n.body.forEach(function (t) {
                ...
                if (c) o < t.length && (o = t.length); else {
                    var r = t.length / 2;
                    if (a < r) throw new h("Too many math in a row: expected " + a + ", but got " + r, t[0])
                }
            });
            for (var p = 0; p < o; ++p) {
                var u = "r", d = 0;
                p % 2 == 1 ? u = "l" : p > 0 && c && (d = 1), r[p] = {type: "align", align: u, pregap: d, postgap: 0}
            }
            return n
        };
        Vr({
            type: "array", names: ["array", "darray"], props: {numArgs: 1}, handler: function (t, e) {
                var r = {
                    cols: (Yt(e[0]) ? [e[0]] : Gt(e[0], "ordgroup").body).map(function (t) {
                        var e = function (t) {
                            var e = Yt(t);
            ...
            handler: function (t) {
                var e = {
                    ...
                    vmatrix: ["|", "|"],
                    Vmatrix: ["\\Vert", "\\Vert"]
                }[t.envName], r = Ur(t.parser, {hskipBeforeAndAfter: !1}, Xr(t.envName));
        ...
        var jr = Fr, $r = new RegExp("^(\\\\[a-zA-Z@]+)[ \r\n\t]*$"), Zr = new RegExp("[\u0300-\u036f]+$"),
            Kr = "(\\\\href|\\\\url)(?:[ \r\n\t]*\\{((?:[^{}\\\\]|\\\\[^]|{[^{}]*})*)\\}|[ \r\n\t]+([^{}])|[ \r\n\t]*([^{}a-zA-Z]))",
            Jr = "([ \r\n\t]+)|(%[^\n]*(?:\n|$)|[!-\\[\\]-\u2027\u202a-\ud7ff\uf900-\uffff][\u0300-\u036f]*|[\ud800-\udbff][\udc00-\udfff][\u0300-\u036f]*|\\\\verb\\*([^]).*?\\3|\\\\verb([^*a-zA-Z]).*?\\4|" + Kr + "|\\\\[a-zA-Z@]+[ \r\n\t]*|\\\\[^\ud800-\udfff])",
            Qr = (new RegExp("^\\\\[a-zA-Z@]+"), new RegExp("^" + Kr)), tn = function () {
                function t(e, r) {
                    a()(this, t), this.input = e, this.settings = r, this.tokenRegex = new RegExp(Jr, "g")
                }
                ...
                return t.prototype.lex = function () {
                    ...
                    if (null === r || r.index !== e) throw new h("Unexpected character: '" + t[e] + "'", new i(t[e], new o(this, e, e + 1)));
                    var n = r[2] || " ", a = n.match($r);
                    return a && (n = a[1] + n.slice(a[0].length)), "%" === n[0] ? ("\n" !== n[n.length - 1] && this.settings.reportNonstrict("commentAtEnd", "% comment has no terminating newline; LaTeX would fail because of commenting the end of math mode (e.g. $)"), this.lex()) : new i(n, new o(this, e, this.tokenRegex.lastIndex))
                }, t
            }(), en = function () {
                function t() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    a()(this, t), this.current = r, this.builtins = e, this.undefStack = []
                }

                return t.prototype.beginGroup = function () {
                    this.undefStack.push({})
                }, t.prototype.endGroup = function () {
                    if (0 === this.undefStack.length) throw new h("Unbalanced namespace destruction: attempt to pop global namespace; please report this as a bug");
                    ...
                    if (arguments.length > 2 && void 0 !== arguments[2] && arguments[2]) {
                        for (var r = 0; r < this.undefStack.length; r++) delete this.undefStack[r][t];
        ...
        }), an("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"), an("\\TextOrMath", function (t) {
        ...
        an("\\char", function (t) {
            var e = t.popToken(), r = void 0, n = "";
            if ("'" === e.text) r = 8, e = t.popToken(); else if ('"' === e.text) r = 16, e = t.popToken(); else if ("`" === e.text) if ("\\" === (e = t.popToken()).text[0]) n = e.text.charCodeAt(1); else {
                if ("EOF" === e.text) throw new h("\\char` missing argument");
                n = e.text.charCodeAt(0)
            } else r = 10;
            if (r) {
                if (null == (n = on[e.text]) || n >= r) throw new h("Invalid base-" + r + " digit " + e.text);
                for (var a = void 0; null != (a = on[t.future().text]) && a < r;) n *= r, n += a, t.popToken()
            }
            return "\\@char{" + n + "}"
        });
        var sn = function (t, e) {
            var r = t.consumeArgs(1)[0];
            if (1 !== r.length) throw new h("\\gdef's first argument must be a macro name");
            var n = r[0].text, a = 0;
            for (r = t.consumeArgs(1)[0]; 1 === r.length && "#" === r[0].text;) {
                if (1 !== (r = t.consumeArgs(1)[0]).length) throw new h('Invalid argument number length "' + r.length + '"');
                if (!/^[1-9]$/.test(r[0].text)) throw new h('Invalid argument number "' + r[0].text + '"');
                if (a++, parseInt(r[0].text) !== a) throw new h('Argument number "' + r[0].text + '" out of order');
                r = t.consumeArgs(1)[0]
            }
        ...
        var hn = function (t, e, r) {
            ...
            if (1 !== n.length) throw new h("\\newcommand's first argument must be a macro name");
            var a = n[0].text, o = t.isDefined(a);
            if (o && !e) throw new h("\\newcommand{" + a + "} attempting to redefine " + a + "; use \\renewcommand");
            if (!o && !r) throw new h("\\renewcommand{" + a + "} when command " + a + " does not yet exist; use \\newcommand");
            var i = 0;
        ...
        an("\\dots", function (t) {
            ...
            return r in ln ? e = ln[r] : "\\not" === r.substr(0, 4) ? e = "\\dotsb" : r in $.math && d.contains(["bin", "rel"], $.math[r].group) && (e = "\\dotsb"), e
        });
        var mn = {
            ")": !0,
            "]": !0,
            ...
            return t.prototype.feed = function (t) {
                ...
                for (var e = [], r = 0; r < t; ++r) {
                    ...
                    if ("{" === n.text) {
                        for (var a = [], o = 1; 0 !== o;) {
                            var i = this.popToken();
                            if (a.push(i), "{" === i.text) ++o; else if ("}" === i.text) --o; else if ("EOF" === i.text) throw new h("End of input in macro argument", n)
                        }
                        a.pop(), a.reverse(), e[r] = a
                    } else {
                        if ("EOF" === n.text) throw new h("End of input expecting macro argument");
                        e[r] = [n]
                    }
                }
                return e
                ...
                if (this.expansionCount++, this.expansionCount > this.settings.maxExpand) throw new h("Too many expansions: infinite loop or need to increase maxExpand setting");
                var n = r.tokens;
                if (r.numArgs) for (var a = this.consumeArgs(r.numArgs), o = (n = n.slice()).length - 1; o >= 0; --o) {
                    var i = n[o];
                    if ("#" === i.text) {
                        if (0 === o) throw new h("Incomplete placeholder at end of macro body", i);
                        if ("#" === (i = n[--o]).text) n.splice(o + 1, 1); else {
                            if (!/^[1-9]$/.test(i.text)) throw new h("Not a valid argument number", i);
                            var s;
                ...
                if ("string" == typeof r) {
                    ...
                    for (var o = new tn(r, this.settings), i = [], s = o.lex(); "EOF" !== s.text;) i.push(s), s = o.lex();
                    return i.reverse(), {tokens: i, numArgs: n}
                }
                return r
            }, t.prototype.isDefined = function (t) {
                return this.macros.has(t) || Pr.hasOwnProperty(t) || $.math.hasOwnProperty(t) || $.text.hasOwnProperty(t) || pn.hasOwnProperty(t)
            }, t
        }(), dn = {
            "\u0301": {text: "\\'", math: "\\acute"},
            "\u0300": {text: "\\`", math: "\\grave"},
        ...
        var xn = function () {
            function t(e, r) {
                a()(this, t), this.mode = "math", this.gullet = new un(e, r, this.mode), this.settings = r, this.leftrightDepth = 0
            }

            return t.prototype.expect = function (t) {
                var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                if (this.nextToken.text !== t) throw new h("Expected '" + t + "', got '" + this.nextToken.text + "'", this.nextToken);
                e && this.consume()
                ...
                for (var e = -1, r = void 0, n = 0; n < t.length; n++) {
                    var a = Ut(t[n], "infix");
                    if (a) {
                        if (-1 !== e) throw new h("only one infix operator per group", a.token);
                        e = n, r = a.replaceWith
                    }
                }
                if (-1 !== e && r) {
                    var o = void 0, i = void 0, s = t.slice(0, e), l = t.slice(e + 1);
                    o = 1 === s.length && "ordgroup" === s[0].type ? s[0] : {
                        type: "ordgroup",
                        mode: this.mode,
                        body: s
                    ...
                    return ["\\\\abovefrac" === r ? this.callFunction(r, [o, t[e], i], []) : this.callFunction(r, [o, i], [])]
                }
                return t
                ...
                if (!a) {
                    if (this.settings.throwOnError || "\\" !== this.nextToken.text[0]) throw new h("Expected group after '" + n + "'", r);
                    return this.handleUnsupportedCmd()
                }
                if ("fn" === a.type) {
                    if (Pr[a.result].greediness > t.SUPSUB_GREEDINESS) return this.parseGivenFunction(a);
                    throw new h("Got function '" + a.result + "' with no arguments as " + e, r)
                }
                return a.result
                ...
                for (var r = void 0, n = void 0; ;) {
                    ...
                    if ("\\limits" === a.text || "\\nolimits" === a.text) {
                        var o = Ut(e, "op");
                        if (!o) throw new h("Limit controls must follow a math operator", a);
                        var i = "\\limits" === a.text;
                        ...
                        for (this.consume(); "'" === this.nextToken.text;) l.push(s), this.consume();
                        "^" === this.nextToken.text && l.push(this.handleSupSubscript("superscript")), r = {
                            type: "ordgroup",
                            mode: this.mode,
                            body: l
                        }
                ...
                return r || n ? {type: "supsub", mode: this.mode, base: e, sup: r, sub: n} : e
                ...
                if ("\\begin" === e.result) {
                    var r = Gt(this.parseGivenFunction(e), "environment"), n = r.name;
                    if (!jr.hasOwnProperty(n)) throw new h("No such environment: " + n, r.nameGroup);
                    var a = jr[n], o = this.parseArguments("\\begin{" + n + "}", a), i = o.args, s = o.optArgs,
                        l = {mode: this.mode, envName: n, parser: this}, m = a.handler(l, i, s);
                    this.expect("\\end", !1);
                    var c = this.nextToken, p = this.parseFunction();
                    if (!p) throw new h("failed to parse function after \\end");
                    if ((p = Gt(p, "environment")).name !== n) throw new h("Mismatch: \\begin{" + n + "} matched by \\end{" + p.name + "}", c);
                    return m
                }
                ...
                if ("fn" === t.type) {
                    var r = t.result, n = Pr[r];
                    if ("text" === this.mode && !n.allowedInText) throw new h("Can't use function '" + r + "' in text mode", t.token);
                    ...
                    var o = this.parseArguments(r, n), i = o.args, s = o.optArgs, l = t.token;
                    return this.callFunction(r, i, s, l, e)
                }
                return t.result
            }, t.prototype.callFunction = function (t, e, r, n, a) {
                var o = {funcName: t, parser: this, token: n, breakOnTokenText: a}, i = Pr[t];
                ...
                for (var n = e.greediness, a = [], o = [], i = 0; i < r; i++) {
                    var s = e.argTypes && e.argTypes[i], l = i < e.numOptionalArgs;
                    i > 0 && !l && this.consumeSpaces(), 0 !== i || l || "math" !== this.mode || this.consumeSpaces();
                    var m = this.nextToken, c = s ? this.parseGroupOfType(s, l) : this.parseGroup(l);
                    if (!c) {
                        if (l) {
                            o.push(null);
                            continue
                        }
                        if (this.settings.throwOnError || "\\" !== this.nextToken.text[0]) throw new h("Expected group after '" + t + "'", m);
                        c = gn(this.handleUnsupportedCmd(), m)
                    }
                    var p = void 0;
                    if ("fn" === c.type) {
                        if (!(Pr[c.result].greediness > n)) throw new h("Got function '" + c.result + "' as argument to '" + t + "'", m);
                ...
                if ("original" === t && (t = this.mode), "color" === t) return this.parseColorGroup(e);
                if ("size" === t) return this.parseSizeGroup(e);
                if ("url" === t) throw new h("Internal bug: 'url' arguments should be handled by Lexer", this.nextToken);
                ...
                for (var n = "", a = this.nextToken, o = a; this.nextToken.text !== (e ? "]" : "}");) {
                    if ("EOF" === this.nextToken.text) throw new h("Unexpected end of input in " + t, a.range(this.nextToken, n));
                ...
                var r = this.mode;
                this.mode = "text";
                for (var n = this.nextToken, a = n, o = ""; "EOF" !== this.nextToken.text && t.test(o + this.nextToken.text);) o += (a = this.nextToken).text, this.consume();
                ...
                if (!function (t) {
                    return "string" != typeof t && (t = t.unit), t in Tt || t in At || "ex" === t
                }(a)) throw new h("Invalid unit: '" + a.unit + "'", e);
                return gn({type: "size", mode: this.mode, value: a, isBlank: r}, e)
            }, t.prototype.parseGroup = function (t, e) {
                var r = this.mode, n = this.nextToken;
                if (this.nextToken.text === (t ? "[" : "{")) {
                    e && this.switchMode(e), this.gullet.beginGroup(), this.consume();
                    var a = this.parseExpression(!1, t ? "]" : "}"), i = this.nextToken;
                    return e && this.switchMode(r), this.gullet.endGroup(), this.expect(t ? "]" : "}"), gn({
                        type: "ordgroup",
                        mode: this.mode,
                        loc: o.range(n, i),
                        body: a
                ...
                for (var e = t.length - 1, r = 0; r < e; ++r) {
                    var n = t[r], a = n.text;
                    "-" === a && "-" === t[r + 1].text && (r + 1 < e && "-" === t[r + 2].text ? (t.splice(r, 3, {
                        type: "textord",
                        mode: "text",
                        loc: o.range(n, t[r + 2]),
                        text: "---"
                        ...
                        loc: o.range(n, t[r + 1]),
                        text: "--"
                    }), e -= 1)), "'" !== a && "`" !== a || t[r + 1].text !== a || (t.splice(r, 2, {
                        type: "textord",
                        mode: "text",
                        loc: o.range(n, t[r + 1]),
                        text: a + a
                ...
                if (Pr[e]) return function (t) {
                    return {type: "fn", result: t.text, token: t}
                }(t);
                if (/^\\(href|url)[^a-zA-Z]/.test(e)) {
                    var r = e.match(Qr);
                    if (!r) throw new h("Internal error: invalid URL token '" + e + "'", t);
                    var n = r[1], a = (r[4] || r[3] || r[2]).replace(/\\([#$%&~_^{}])/g, "$1"),
                        i = /^\s*([^\\/#]*?)(?::|&#0*58|&#x0*3a)/i.exec(a);
                    i = null != i ? i[1] : "_relative";
                    var s = this.settings.allowedProtocols;
                    if (!d.contains(s, "*") && !d.contains(s, i)) throw new h("Forbidden protocol '" + i + "' in " + n, t);
                    ...
                    if (this.consume(), "\\href" === n) {
                        ...
                        return m = "fn" === m.type ? this.parseGivenFunction(m) : m.result, gn(this.callFunction(n, [l, m], []), t)
                    }
                    return gn(this.callFunction(n, [l], []), t)
                }
                if (/^\\verb[^a-zA-Z]/.test(e)) {
                    this.consume();
                    var c = e.slice(5), p = "*" === c.charAt(0);
                    if (p && (c = c.slice(1)), c.length < 2 || c.charAt(0) !== c.slice(-1)) throw new h("\\verb assertion failed --\n                    please report what input caused this bug");
                    return gn({type: "verb", mode: "text", body: c = c.slice(1, -1), star: p}, t)
                }
                fn.hasOwnProperty(e[0]) && !$[this.mode][e[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + e[0] + '" used in math mode', t), e = fn[e[0]] + e.substr(1));
                var u = Zr.exec(e);
                u && ("i" === (e = e.substring(0, u.index)) ? e = "\u0131" : "j" === e && (e = "\u0237"));
                var f = void 0;
                if ($[this.mode][e]) {
                    ...
                    var g = $[this.mode][e].group, x = o.range(t), v = void 0;
                    if (_.hasOwnProperty(g)) {
                        var y = g;
                        v = {type: "atom", mode: this.mode, family: y, loc: x, text: e}
                    } else v = {type: g, mode: this.mode, loc: x, text: e};
                    f = v
                } else {
                    if (!(e.charCodeAt(0) >= 128)) return null;
                    this.settings.strict && (A(e.charCodeAt(0)) ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + e[0] + '" used in math mode', t) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + e[0] + '" (' + e.charCodeAt(0) + ")", t)), f = {
                        type: "textord",
                        mode: this.mode,
                        loc: o.range(t),
                        text: e
                ...
                if (this.consume(), u) for (var b = 0; b < u[0].length; b++) {
                    var w = u[0][b];
                    if (!dn[w]) throw new h("Unknown accent ' " + w + "'", t);
                    var k = dn[w][this.mode];
                    if (!k) throw new h("Accent " + w + " unsupported in " + this.mode + " mode", t);
                    f = {
                        type: "accent",
                        mode: this.mode,
                        loc: o.range(t),
        ...
        xn.endOfExpression = ["}", "\\end", "\\right", "&"], xn.SUPSUB_GREEDINESS = 1;
        var vn = xn, yn = function (t, e) {
            ...
            if (r.gullet.macros.get("\\df@tag")) {
                if (!e.displayMode) throw new h("\\tag works only in display equations");
        ...
        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), bn = function () {
        ...
        var wn = function (t, e, r) {
            ...
            __renderToHTMLTree: function (t, e) {
                ...
                try {
                    return function (t, e, r) {
                        var n = fe(t, Ae(r)), a = Vt.makeSpan(["katex"], [n]);
            ...
            __defineSymbol: Z,
            __defineMacro: an,
            __domTree: {Span: I, Anchor: R, SymbolNode: H, SvgNode: D, PathNode: P, LineNode: F}
        };
        e.default = Sn
    }]).default
});